...
C {vsource.sym} -1095 20 0 0 {name=V5 value="sin(0 -1.65 2000)" savecurrent=false}
C {vsource.sym} -1170 235 0 0 {name=V6 value=1.65 savecurrent=false}
C {vsource.sym} -1170 160 0 0 {name=V7 value="sin(0 1.65 2000)" savecurrent=false}
...
set num_threads 1
run
write testWhole_saturationScheme2.raw
.endc
"
spice_ignore=false
      }
